...
export default function Dashboard() {
  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-[1200px] flex-col px-4 sm:px-6 lg:px-8">
      {/* Static header: branding, page title/date, stats - never scrolls */}
      ...
      {/* Recent Updates, Movement Queue, Coverage Alerts - the ONLY region that scrolls */}
